      ...
      <div>
        <div className="relative">
          <div
            ...
            bg-[#1A1D23] border border-white-100 z-50 absolute inset-y-0 shrink-0 flex flex-col right-0  duration-300 delay-150 md:w-1/2 h-screen`}
          >
            <div
            ...
            <div className="w-full text-white-100 p-2 sm:p-6 pb-10 flex flex-col gap-20 mt-10">
              {NavMenuItems.map((navMenu, index) => (
                ...
                >
                  <div className="flex flex-col gap-2 group">
                    <div className="flex justify-center items-center gap-2">
                      <div className="flex items-center gap-2 group-hover:pr-10 duration-300">
                        ...
                        <div className="text-white-100 font-bold text-5xl uppercase group-hover:text-yellow-200">
                          <a href={navMenu.slug} className="mb-4">
                            {navMenu.name}
                          </a>
                        </div>
                      </div>
                    ...
                    {openMenuIndex === index && (
                      <ul className="relative -left-28 md:-left-32 text-white-100 font-bold text-4xl flex flex-col items-end gap-5">
                        {navMenu?.children &&
