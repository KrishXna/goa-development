          ...
          <ol className="text-white-100/80 text-xl font-normal flex flex-col gap-8 ml-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <ul>
                ...
                <li className="list-disc">
                  ...
                  Participants should review these charges before finalizing
                  their registration.
                </li>
              </ul>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <ul>
                ...
                <li className="list-disc">
                  It&apos;s important to note that the training course fee does
                  not grant participants access to the leading conference.
                  Separate registration is required for conference attendance.
                </li>
              </ul>
            </div>
            <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <ul>
                <li className="list-disc">
                  All participants are expected to adhere to the BSides Goa Code
                  of Conduct throughout the training course. The Code of Conduct
                  can be found here.
                </li>
              </ul>
            </div>
