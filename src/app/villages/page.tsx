      ...
      <Container>
        ...
        <div className="flex flex-col gap-8">
          ...
          <p className="text-white-100/80 text-xl font-normal">
            Embark on a voyage of discovery at BSides Goa's Villages! Immerse
            yourself in a world of technological marvels and exploration as you
            engage with cutting-edge concepts, hands-on activities, and
          ...
          <div>
            ...
            <ul className="text-white-100/80 text-xl font-normal flex flex-col gap-4 pl-2 md:pl-8 mt-4">
              ...
              <li className="list-disc">
                Win Cool Goodies: Don't miss the chance to snag some exciting
                rewards by participating in our competitions. Show off your
                skills and walk away with more than just knowledge!
              </li>
            </ul>
          </div>
          <p className="text-white-100/80 text-xl font-normal">
            Don't miss out on the opportunity to take your learning to the next
            level at BSides Goa's Villages. Experience education like never
            before, and emerge with enhanced skills and insights. Join us in
            this dynamic journey of exploration and growth!
          </p>
        </div>
        <Sponsors />
      </Container>
