...
import BannerImg from "@/assets/tinified/code-of-conduct.jpg";
        ...
        <Container glowEffect>
          <div className="flex flex-col gap-8">
            ...
            <p className="text-white-100/80 text-xl font-normal">
              ...
              involved – attendees, speakers, sponsors, and volunteers – to
              adhere to the following code of conduct. By attending our
              conference, you are agreeing to support these principles,
              contributing to a safe and enriching experience for everyone.
            </p>
            <ul className="text-white-100/80 text-xl font-normal flex flex-col gap-8 pl-2 md:pl-8">
              <li className="list-disc">
                ...
                or technological preferences. We celebrate diversity and value
              ...
              <li className="list-disc">
                ...
                you have any concerns about inappropriate behavior, please
                notify a member of the conference staff promptly. You can also
                contact us at [email address] to report an incident. Our team is
                committed to addressing any issues promptly and discreetly.
              </li>
              <li className="list-disc">
                Consequences of Violation: Participants who violate this code of
                conduct may face sanctions, including expulsion from the
                conference without a refund, and may be prohibited from
                attending future BSides Goa events. Such actions will be
                determined at the discretion of the conference organizers.
              </li>
            </ul>
            <p className="text-white-100/80 text-xl font-normal">
              We sincerely thank all participants for their cooperation in
              creating an environment that is respectful, welcoming, and
              enjoyable for everyone. Your commitment to upholding these
              principles helps ensure a positive experience for all attendees at
              BSides Goa.
            </p>
          </div>
          {/* <Sponsors /> */}
